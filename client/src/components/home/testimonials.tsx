...
const testimonials = [
  {
    id: 1,
    content: "Ntekcomputers delivered my business cards and brochures with exceptional quality. Their attention to detail and customer service is outstanding.",
    author: "Rajiv Sharma",
  ...
  {
    id: 2,
    content: "The team at Ntekcomputers helped us with our event banners on a tight deadline. The results were impressive and the service was professional from start to finish.",
    author: "Priya Patel",
  ...
  {
    id: 3,
    content: "I've been using Ntekcomputers for all my corporate printing needs for over 2 years now. Their consistent quality and reliability keep me coming back.",
    author: "Amit Singh",
